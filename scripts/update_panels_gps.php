<?php
/**
 * Script one-shot — mise à jour des coordonnées GPS de 110 panneaux.
 * Mode "respect" : ne touche PAS les panneaux qui ont déjà des coords
 * (évite d'écraser un correctif terrain plus récent).
 *
 * Exécution :
 *   php artisan tinker --execute="require 'scripts/update_panels_gps.php';"
 */

use App\Models\Panel;

echo "\n=== MISE À JOUR GPS PANNEAUX ===\n";
