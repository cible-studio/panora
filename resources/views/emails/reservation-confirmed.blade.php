...
<tr><td align="center">
    ...
    <tr><td style="background:#16a34a;padding:18px 26px;color:#fff">
        ...
        <div style="font-size:18px;font-weight:700;margin-top:4px">✅ Réservation confirmée</div>
    </td></tr>
    <tr><td style="padding:26px">
        ...
        <table role="presentation" width="100%" style="font-size:13px;border-collapse:collapse;margin:18px 0">
            <tr><td style="padding:4px 0;color:#9ca3af;width:40%">Période</td>
                <td style="padding:4px 0">
                    {{ \Carbon\Carbon::parse($reservation->start_date)->format('d/m/Y') }} →
                    {{ \Carbon\Carbon::parse($reservation->end_date)->format('d/m/Y') }}
                </td></tr>
            <tr><td style="padding:4px 0;color:#9ca3af">Montant total</td>
                <td style="padding:4px 0;font-weight:700;color:#16a34a;font-size:15px">
