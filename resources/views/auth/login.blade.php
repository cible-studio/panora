<x-guest-layout>
    ...
    <style>
        ...
        .fg input:focus {
            ...
            box-shadow: 0 0 0 4px rgba(226, 6, 19, .08);
        }

        /* Bouton */
        .btn-login {
            background: linear-gradient(135deg, #ff0015, #d80012) !important;
            border: none;
            box-shadow: 0 10px 20px rgba(226, 6, 19, .18);
        }

        /* Bloc sécurité */
        div[style*="Connexion sécurisée"] {
        ...
        .btn-login {
            ...
            padding: 12px;
            border-radius: 9px;
            background: linear-gradient(135deg, var(--accent), #c00010);
            color: #fff;
            font-weight: 700;
            font-size: 14px;
            border: none;
        ...
        .btn-login:hover {
            opacity: .9;
            box-shadow: 0 4px 20px rgba(226, 6, 19, .3);
    ...
    <div class="auth-logo mt-4 flex flex-col items-center">
        <img class="w-80" src="{{ asset('images/panora.png') }}" alt="Logo">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="fg">
                ...
                <input id="email" type="email" name="email" value="{{ old('email') }}"
                    placeholder="vous@cibleci.ci" class="{{ $errors->has('email') ? 'is-error' : '' }}" required
            ...
            <div class="fg">
                ...
                <div style="position:relative;">
                    <input id="password" type="password" name="password" placeholder="••••••••"
                        class="{{ $errors->has('password') ? 'is-error' : '' }}" style="padding-right:40px;" required
