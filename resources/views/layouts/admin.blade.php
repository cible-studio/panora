...
>>>>>>> feature/DEV-B-setup
    ...
    .toast.error   { background:#1c0a0a; border-color:#7f1d1d; color:#f87171; }
    .toast.warning { background:#1c1200; border-color:#78350f; color:#fbbf24; }
    .toast.info    { background:#0c1a2e; border-color:#1e3a5f; color:#60a5fa; }
    .toast-icon    { font-size:15px; flex-shrink:0; margin-top:1px; }
    .toast-msg     { flex:1; }
    .toast-close   {
        margin-left:4px; font-size:13px; opacity:.5; cursor:pointer;
    ...
    @keyframes toastOut {
        ...
        to   { opacity:0; transform:translateX(24px); max-height:0; margin-bottom:-8px; padding:0; }
    }
    </style>
...
.toast-icon   {font-size:15px;flex-shrink:0;margin-top:1px;}
.toast-msg    {flex:1;}
.toast-close  {margin-left:4px;font-size:13px;opacity:.5;cursor:pointer;
               background:none;border:none;color:inherit;padding:0;
               flex-shrink:0;line-height:1;}
.toast-close:hover{opacity:1;}
@keyframes toastIn{
