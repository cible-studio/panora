            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-bottom:14px">
                ...
                <div>
                    <div style="display:flex;align-items:center;justify-content:space-between;gap:8px;margin-bottom:5px">
                        ...
                        {{-- 2026-06-19 — Modale rapide (au lieu de naviguer). L'équipe créée
                             est ajoutée au select sel-team et sélectionnée automatiquement. --}}
...
/* Bouton "×" clear : positionné proprement, séparé du texte de la campagne
   (avant : le × collait au nom — ex. "380° 2026×" — illisible). */
...
.select2-container--default .select2-selection--single .select2-selection__clear > span { display:none; } /* masque l'aria sr text "&times;" supplémentaire */
