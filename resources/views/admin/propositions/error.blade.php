...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  body{background:var(--dark);color:var(--text);font-family:'DM Sans',system-ui,sans-serif;min-height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px}
  ...
  .logo{font-weight:800;color:var(--gold);margin-top:28px;font-size:14px}
</style>
</head>
<body>
<div class="card">
