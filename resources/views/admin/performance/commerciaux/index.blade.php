...
<div class="perf-page">
    ...
    {{-- Tableau leaderboard --}}
    @php
        // 2026-07-08 : le menu déroulant "Trier par" a été retiré (redondant)
        // car les cards KPI en haut sont maintenant cliquables et gèrent
        // le tri. Le sous-titre du tableau affiche juste le tri courant.
        $sortLabels = [
            'ca_ttc'                 => 'CA TTC',
            'ca_ht'                  => 'CA HT',
