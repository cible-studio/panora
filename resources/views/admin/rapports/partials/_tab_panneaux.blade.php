<div id="panel-panneaux" class="rpt-panel" style="display:none">
    ...
    <div style="background:linear-gradient(90deg,#fff7ed,#fef3c7);border:1px solid #fed7aa;border-radius:12px;padding:12px 16px;margin-bottom:14px;display:flex;justify-content:space-between;align-items:center;gap:12px;flex-wrap:wrap">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap">
            ...
            <a href="{{ route('admin.rapports.panneaux-classification') }}"
               style="display:inline-flex;align-items:center;gap:6px;padding:8px 14px;background:#7c3aed;color:#fff;border:none;border-radius:8px;font-size:11px;font-weight:700;text-decoration:none;text-transform:uppercase;letter-spacing:.5px"
               title="Panneaux classés en 3 catégories : à l'année, intermédiaire, jamais occupés. Chevalets et façades murales exclus.">
                🎯 Classification par occupation
            </a>
        </div>
    </div>
