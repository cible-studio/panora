                    ...
                    <div style="display:flex; align-items:center; gap:12px; cursor:pointer;" onclick="toggleLit()">
                        <div id="toggle-track"
                             style="
                                ...
                                border-radius:14px;
                                background: {{ old('is_lit', $panel->is_lit) ? '#e8a020' : '#d1d5db' }};
                            ...
                            <div id="toggle-thumb"
                                 style="
                                    ...
                                    left: {{ old('is_lit', $panel->is_lit) ? '25px' : '3px' }};
                        ...
                        <div>
                            <div id="toggle-label"
                                 style="font-size:14px; font-weight:600; color:{{ old('is_lit', $panel->is_lit) ? '#e8a020' : 'var(--text2)' }};">
