...
<div class="main-wrapper">
    ...
    {{-- ══ SIDEBAR DESKTOP ══ --}}
    <div style="display:flex;flex-shrink:0;" class="hidden lg:flex">
        <div class="sidebar-wrapper w-64">
        <div class="sidebar">
            <div class="sidebar-header">
                <img id="logo-img" src="{{ asset('images/logob.png') }}" alt="CIBLE CI" class="h-8 w-auto">
        ...
        <div style="width:4px;display:flex;flex-direction:column;">
