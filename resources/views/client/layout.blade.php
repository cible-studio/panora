...
<body>
    ...
    <div class="main-wrapper">
            ...
            <div class="sidebar">
                ...
                <nav class="flex-1 px-3 py-4 overflow-y-auto" style="display:flex;flex-direction:column;gap:2px;">
                    ...
                    <a href="{{ route('client.propositions') }}"
                        class="nav-item {{ request()->routeIs('client.propositions*') ? 'active' : '' }}">
                        <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="{{ route('client.campagnes') }}"
                        class="nav-item {{ request()->routeIs('client.campagnes*') ? 'active' : '' }}">
                        <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="{{ route('client.profil') }}"
                        class="nav-item {{ request()->routeIs('client.profil*') ? 'active' : '' }}">
                        <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="{{ route('client.password.change') }}"
                        class="nav-item {{ request()->routeIs('client.password*') ? 'active' : '' }}">
                        <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <div class="sidebar-footer-section">
                    <div style="display:flex;align-items:center;gap:10px;padding:8px;margin-bottom:8px;">
                        ...
                        <div style="min-width:0;flex:1;">
                            <div
                                style="font-size:12px;font-weight:600;color:var(--text);overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">
                                {{ $client->name }}</div>
                    ...
                    <form method="POST" action="{{ route('client.logout') }}">
                        ...
                        <button type="submit" class="nav-item"
                            style="color:#ef4444;background:rgba(239,68,68,.06);border:1px solid rgba(239,68,68,.15);">
                            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="#ef4444"
                                stroke-width="2">
        ...
        {{-- ══ SIDEBAR MOBILE ══ --}}
        <div id="sidebar-overlay" class="fixed inset-0 bg-black/60 z-40 hidden backdrop-blur-sm"
            onclick="closeSidebar()"></div>
        <aside id="mobile-sidebar"
            class="fixed top-0 left-0 z-50 w-64 h-full sidebar-transition -translate-x-full sidebar">
            <div class="sidebar-header">
            ...
            <div class="topbar">
                <div style="display:flex;align-items:center;justify-content:space-between;">
                    ...
                    <div style="display:flex;align-items:center;gap:12px;">
                        ...
                        <button id="theme-toggle-btn" onclick="toggleClientTheme()" title="Basculer dark/light"
        ...
        transition:all 0.3s ease; position:relative;">
            ...
            box-shadow:0 2px 8px rgba(0,0,0,0.3);">
                                    ...
                                    {{-- Icône Lune --}}
                                    <svg id="icon-moon" style="width:12px;height:12px;color:#000;"
                                        fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" />
                                    </svg>

                                    {{-- Icône Soleil (caché par défaut) --}}
                                    <svg id="icon-sun" style="width:12px;height:12px;color:#000;display:none;"
                                        fill="currentColor" viewBox="0 0 24 24">
            ...
            <footer style="border-top:1px solid var(--border);background:var(--footer-bg);">
                <div style="padding:20px 24px;">
                    <div
                        style="display:flex;flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px;font-size:11px;color:var(--text3);">
                        <div>© {{ date('Y') }} CIBLE CI — Régie OOH Côte d'Ivoire</div>
                        <div style="display:flex;gap:20px;">
                            <a href="#" style="color:var(--text3);text-decoration:none;"
                                onmouseover="this.style.color='var(--text)'"
                                onmouseout="this.style.color='var(--text3)'">Mentions légales</a>
                            <a href="#" style="color:var(--text3);text-decoration:none;"
                                onmouseover="this.style.color='var(--text)'"
                                onmouseout="this.style.color='var(--text3)'">Confidentialité</a>
                            <a href="#" style="color:var(--text3);text-decoration:none;"
                                onmouseover="this.style.color='var(--text)'"
                                onmouseout="this.style.color='var(--text3)'">Contact</a>
                        </div>
                    </div>
                </div>
            </footer>
    ...
    {{-- FAB Mobile --}}
    <button
        class="fixed bottom-5 left-5 z-50 lg:hidden w-11 h-11 rounded-full flex items-center justify-center shadow-lg"
    ...
    <div id="toast-container"
        style="position:fixed;bottom:20px;right:20px;z-index:9999;display:flex;flex-direction:column;gap:8px;max-width:360px;">
    </div>
    ...
    <script>
        ...
        function showToast(message, type = 'success') {
            ...
            toast.style.cssText =
                `background:var(--surface);border:1px solid var(--border2);border-left:3px solid ${color};border-radius:10px;padding:12px 16px;font-size:13px;color:var(--text);box-shadow:0 8px 24px rgba(0,0,0,.25);`;
